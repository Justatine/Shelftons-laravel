...
<html lang="en">
  ...
  <body style="background-image: url('../images/b7.jpg');  background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="edit-form">
                  ...
                  <input type="date" id="mreturnDate" name="returnDate" class="form-control">
                  ...
                  <input type="number" id="mfine" name="fine" class="form-control" min="0">
    ...
    <script>
      $(document).ready(function() {
        $('#mborrowStatus').on('change', function() { 
          if ($('#mborrowStatus').val() === "Approved") {
            $('#mreturnStatus').val('Not returned');
          }
        });
      });
    </script>    
