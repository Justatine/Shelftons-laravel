...
<html lang="en">
  <head>
  	<title>Librarian Panel | Shelftons</title>
    <meta charset="utf-8">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1;">
            <div class="container-fluid">
              <h2 id="sidebarCollapse" > Hi, welcome Librarian
            ...
            <div class="col-sm-7">
                ...
                <div class="card" style="display:inline-block;">
                  <div class="card-body">
                    ...
                    <center>
                      ...
                      <a href="{{ route('librarian.users') }}" class="card-link">View users</a>                      
                    </center>
                  </div>
              </div>   
              ...
              <div class="card" style="display:inline-block;">
                  <div class="card-body">
                    ...
                    <center>
                      <a class="card-link" data-toggle="modal" data-target="#newbook" title="Add book">Add new book</a> 
                      <a href="{{ route('librarian.books') }}" class="card-link">View books</a>                      
                    </center>
                  </div>
              </div>
              ...
              <div class="card" style="display:inline-block;">
                <div class="card-body">
                  ...
                  <center>
                    <a href="{{ route('librarian.borrowers') }}" class="card-link">Manage borrow transactions</a>
                  </center>
                </div>
            </div>       
              </div>
