...
<html lang="en">
  ...
  <body style="background-image: url('../images/b7.jpg');  background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="#" data-toggle="modal" data-target="#adduser" title="Add user">Add User</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="modal" data-target="#addAdmin" title="Add admin">Add Admin</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#" data-toggle="modal" data-target="#addlibrarian" title="Add librarian">Add Librarian</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="container" style="background-color: white; height: 530px; border-radius: 0.25rem;   box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.2);">
                <div class="row">
                  ...
                  <div class="col-sm-4 mb-4" style="padding: 5px 5px; text-align: right;">
                ...
                <div class="row ml-5">
                  <div id="usertablecontainer" style="overflow: auto; height: 450px; width: 1020px;">
    ...
    <!-- ADD LIBRARIAN MODAL -->
    <div class="modal fade bd-example-modal-lg" id="addlibrarian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">
              <img src="../images/icon1.png" alt="" style="height: 50px; width: 50px;">Add new Librarian
            </h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          ...
          <div class="modal-body">
            <div class="container" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
              <form id="addlibrarianform" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-sm-2">
                    <div class="row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label for="fname">Current address:</label>
                          <input type="text" id="current_address" name="current_address" class="form-control" placeholder="Street/Purok/Barangay" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="text-align: right;">
                      <div class="col-sm-12">
                        <button type="submit" id="submitBtn" class="btn btn-primary">Save new librarian</button>                   
                      </div>
                    </div><br>
                  </div>
                </div>
    ...
    <!-- ADD ADMIN  MODAL -->
    <div class="modal fade bd-example-modal-lg" id="addAdmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">
              <img src="../images/icon1.png" alt="" style="height: 50px; width: 50px;">Add new Admin
            </h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
              ...
              <form id="addadminForm" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="row" style="text-align: right;">
                      <div class="col-sm-12">
                        <button type="submit" id="submitBtn" class="btn btn-primary">Save new admin</button>                   
                      </div>
                    </div><br>
                  </div>
                </div>
